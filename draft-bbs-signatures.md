...
**Note** Implementing this operation as defined below for a particular ciphersuite is RECOMMENDED,
however implementers are able to define an alternative key generation procedure provided it outputs
a secret key of the equivalent form.
