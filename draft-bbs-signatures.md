...
- XOF: A cryptographically secure extendable-output function like SHAKE128 or SHAKE256.

- point\_to\_octets: A function that returns the canonical representation of the point P as an octet string.

- octets\_to\_point: A function that returns the point P corresponding to the canonical representation ostr, or INVALID if ostr is not a valid output of point_to_octets.
