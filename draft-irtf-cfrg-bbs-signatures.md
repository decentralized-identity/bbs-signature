...
10. if length(generators) != L + 1, return INVALID
11. (Q_1, MsgGenerators) = generators
12. (H_1, ..., H_L) = MsgGenerators
13. (H_i1, ..., H_iR) = (MsgGenerators[i1], ..., MsgGenerators[iR])
14. (H_j1, ..., H_jU) = (MsgGenerators[j1], ..., MsgGenerators[jU])
